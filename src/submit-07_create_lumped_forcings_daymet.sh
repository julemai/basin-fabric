...
# submit with:
#       sbatch submit-07_create_lumped_forcings_daymet.sh
...
forcings="/project/6070465/julemai/blended-model-na/data_in/daymet_v4R1/"
...
for bb in ${basins} ; do
    ...
    python 07_create_lumped_forcings_daymet.py -s ${region_tag_python} -b ${bb} -f ${forcings} -y graham
...
# 23887794  --> 11 missing basins                 ;  1GB ; 72h   ; 135 tasks (each 1 basin)         
#
#
